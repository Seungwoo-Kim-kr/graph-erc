...
problem is not yet solved by architectural innovation alone. Our work
...
dialogue. This gap motivates our faithfulness-oriented evaluation
framework, which treats grounding in retrieved evidence as a first-class
...
uses the retrieved evidence in its reasoning. Our work adapts and
...
our approach serialises the dialogue graph into natural language and
...
model explanations are grounded in the supplied context. Our claim-level
faithfulness evaluation framework bridges this gap by adapting the
